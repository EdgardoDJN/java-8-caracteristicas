package java8.java8_examples.map;
...
public class App {
	...
	public void imprimir_v7() {
        //Version 7 de java
        //entrySet() -> Lista de valores que tiene el mapa
	...
	public void insertarSiAusente() {
        //Agrega un elemento si esta ausente sino no agrega nada
		map.putIfAbsent(2, "Jaime");
        //si utilizamos put si lo sobreescribe
	}

	public void operarSiPresente() {
        //Si se encuentra una llave hace una determinada operacion
	...
	public void obtenerOrPredeterminado() {
        //Si ya existe muestra ese que esta en el mapa sino muestra el valor por defecto
