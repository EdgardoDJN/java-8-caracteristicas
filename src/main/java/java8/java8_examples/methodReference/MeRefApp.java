package java8.java8_examples.methodReference;
...
public class MeRefApp {
	...
	public void referenciarMetodoInstanciaObjetoArbitrario() {
        ...
        //El array internamente se recorre elemento por elemento y ya es una instancia y se le aplica el metodo compareToIgnoreCase
		//se refiere a la clase predefinida String de la APi java que es la que implementa la interfaz Comparator
	...
	public void referenciarConstructor() {
        ...
        //Las referencia a metodos siempre se apoyan en interfaces funcionales
        //Esta interfaz funcional devuelve una instancia de la clase Persona
        //Debemos siempre apoyarnos en una inerfaz funcional
	...
	public void operar() {
        ...
        //Metodos por referencia no se le envian parametros, java todavia no ha implementado currificacion
	...
	public static void main(String[] args) {
        ...
        // Función que se le estoy mandando como implementación a mi metodo saludar
        // Java utiliza metodos como si fueran parametros para implementar otros metodos
		// op.saludar();
